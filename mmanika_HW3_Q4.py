...
def main(csv_file):
    ...
    print(cum_bw_table)
    venn3([set(relay), set(guard), set(exit)], set_labels=("Middle Relays ({}Kbps)".format(stats["mid_bw"]), "Guard Relays ({}Kbps)".format(stats["guard_only_bw"]), "Exit Relays ({}Kbps)".format(stats["ex_only_bw"])))
